...
from agent_subagent import ORCHESTRATOR_PROMPT, _build_sql_subagents
from tool_policy import HARNESS_PROVIDERS, create_read_only_filesystem_middleware
...
def create_restricted_sql_subagent_graph(
    *,
    ...
    return create_deep_agent(
        ...
        memory=["./AGENTS.md"],
        skills=["./skills/"],
        subagents=_build_sql_subagents(sql_tools, backend),
        backend=backend,
        middleware=[create_read_only_filesystem_middleware(backend)],
    )
